...
void NFC04A1_LED_Init( void )
{
  ...
  GPIO_InitStruct.Pin = NFC04A1_LED1_PIN | NFC04A1_LED2_PIN;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init( NFC04A1_LED1_PIN_PORT, &GPIO_InitStruct );
  GPIO_InitStruct.Pin = NFC04A1_LED3_PIN;
  HAL_GPIO_Init( NFC04A1_LED3_PIN_PORT, &GPIO_InitStruct );
}
...
static HAL_StatusTypeDef STM32_I2C1_Init( uint32_t i2cspeed )
{
  ...
  if( HAL_I2C_GetState(&hNFC04A1_i2c) == HAL_I2C_STATE_RESET )
  {
    ...
    hNFC04A1_i2c.Init.Timing = i2cspeed;
    hNFC04A1_i2c.Init.AddressingMode = I2C_ADDRESSINGMODE_7BIT;
    hNFC04A1_i2c.Init.DualAddressMode = I2C_DUALADDRESS_DISABLE;
    hNFC04A1_i2c.Init.GeneralCallMode = I2C_GENERALCALL_DISABLE;
    hNFC04A1_i2c.Init.NoStretchMode = I2C_NOSTRETCH_DISABLE;
